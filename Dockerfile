...
RUN curl -X POST 'https://api.eu.newrelic.com/v2/applications/1442355/deployments.json' -H 'X-Api-Key:2d81334d6c3e1992f8e39bb4e8512491fb2cc9be8f539ff' -i -H 'Content-Type: application/json' -d '{  "deployment": {    "revision": "ADDITION",    "changelog": "Modified: index.php, Removed: None",    "description": "Production Deployment",    "user": "shaaloua@amazon.com"  }}'
